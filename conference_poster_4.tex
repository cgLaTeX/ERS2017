...
\headerbox{Results 2}{name=conclusion,column=1,span=1,row=0,below=results,above=references}{
  \input{sections/results2}
}

\headerbox{Problem Statement}{name=problem statement,column=0,below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
  \input{sections/problem_statement}
}

\headerbox{Rotating Frame Approximation}{name=results2,column=2,span=2,below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
  \input{sections/rwa}
}
